...
def get_largest_patient_id():
    ...
    node_urls = ['http://127.0.0.1:5000/patients/json', 'http://127.0.0.1:5002/patients/json']
...
def fetch_patients_from_nodes():
    ...
    nodes = ['http://127.0.0.1:5000/patients/json', 'http://127.0.0.1:5002/patients/json']
    all_patients = []
    for node in nodes:
        try:
...
def update_patient_in_nodes(id):
    # URLs of the South and North nodes
    nodes = ['http://127.0.0.1:5000/update_patient', 'http://127.0.0.1:5002/update_patient']
...
def delete_patient_from_nodes(id):
    # URLs of the South and North nodes
    nodes = ['http://127.0.0.1:5000/delete_patient', 'http://127.0.0.1:5002/delete_patient']
