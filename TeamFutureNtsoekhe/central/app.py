...
#update locally
# @app.route('/update_local/<int:id>', methods=['GET', 'POST'])
# def update_local_patient(id):
#     update_patient_from_nodes(id)
...
#         conn.commit()
#         conn.close()
#         return redirect(url_for('list_local_patients'))
...
#     return render_template('update_local_patient.html', patient=patient)
