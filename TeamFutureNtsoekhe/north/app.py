...
def get_largest_patient_id():
    ...
    node_urls = ['http://127.0.0.1:5002/patients/json', 'http://127.0.0.1:5000/patients/json']
...
NODES_SEARCH_URLS = ['http://127.0.0.1:5002/search_patients', 'http://127.0.0.1:5000/search_patients']
