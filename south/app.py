...
# Function to fetch patients from other nodes
...
def update_patient_in_nodes(id):
    # URLs of the South and North nodes
    nodes = ['http://127.0.0.1:5002/update_patient', 'http://127.0.0.1:5001/update_patient']
...
def delete_patient_from_nodes(id):
    # URLs of the South and North nodes
    nodes = ['http://127.0.0.1:5002/delete_patient', 'http://127.0.0.1:5001/delete_patient']
